...
%content%nbsp;cat /proc/sys/net/ipv4/tcp_syn_retries
5
tcp_syn_retries 默认值为 5，也就是 SYN 最大重传次数是 5 次。

接下来，我们继续做实验，把 tcp_syn_retries 设置为 2 次：

%content%nbsp;echo 2 > /proc/sys/net/ipv4/tcp_syn_retries
...
%content%nbsp;cat /proc/sys/net/ipv4/tcp_synack_retries
5
...
%content%nbsp;echo 2 > /proc/sys/net/ipv4/tcp_synack_retries
%content%nbsp;echo 1 > /proc/sys/net/ipv4/tcp_syn_retries
...
%content%nbsp;cat /proc/sys/net/ipv4/tcp_retries2
15
...
面试官：用了HTTPS就安全了吗？会被抓包吗？我竟然回答不上来...
